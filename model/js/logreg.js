    ...
    var loginList=(function () {
        ...
        function login() {
            ...
            if(loginName==""){
                ...
                var surl = LoadUrl() + "axis2/services/MyService/UserLoginCustom";
                $.ajax({
                    type: "POST",
                    url: surl,
                    data: {
        ...
        function changePassword() {
            ...
            if(nameVal == ""){
                ...
                var surl = LoadUrl() + "axis2/services/MyService/changePasswordCustom";
                $.ajax({
                    type: "POST",
                    url: surl,
                    data: {
                    ...
                    dataType: "text",
                    success: function (result) {
                        var JsonResult = jQuery.parseJSON(loadXML(result));
                        if(JsonResult){
                            layer.msg('恭喜你修改成功,请登陆',function () {
                                sessionStorage.setItem("loginName",nameVal);
