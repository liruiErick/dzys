...
(function( $ ){
	...
	var methods = {
		...
		{
			var fonts = { "默认"      : "微软雅黑,Micsoft Yahei",
				          "Sans serif": "arial,helvetica,sans-serif",
						  "宋体"	 	  : "宋体,SimSun",
						  "微软雅黑"	  : "微软雅黑,Micsoft Yahei",
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											...
											"custom":function(button){
													var editor = $(this);
													var flag = 0;
													var paletteCntr   = $('<div/>',{id:"paletteCntr",class:"activeColour", css :{"display":"none","width":"335px"}}).click(function(event){
...
/*																	if(window.getSelection){
                                                                        ...
                                                                        console.log($("#addcontentWrap").find("div#EditorContent").get(0).selection.createRange().text);
																	}*/
						   ...
						   'outdent'	: { "text": "Outdent", 
							...
							'splchars'	: { "text": "S", 
											...
											"custom":function(button){
													...
													var flag =0;
													var splCharDiv = $('<div/>',{id:"specialchar", class:"specialCntr", css :{"display":"none"}}).click(function(event) {
			...
			var menuGroups = {'texteffects' : ['bold', 'italics', 'underline', 'color'],
							  'aligneffects': ['undo', 'redo'],
							  /*'textformats': ['indent', 'outdent', 'block_quote', 'ol', 'ul'],*/
                              /*'textformats': ['indent', 'outdent'],*/
							  'fonteffects' : ['fonts', 'styles', 'font_size'],
							  'actions' : ['l_align','c_align', 'r_align', 'justify'],
							            			...
							            			class:"modal-content"
									            		...
									            		class:"modal-footer"
								                			...
								                			e.preventDefault();
								               					...
								               					return function(){onSave.apply(obj)}}(this)))
	         								  		)
       											)	
       									);	
